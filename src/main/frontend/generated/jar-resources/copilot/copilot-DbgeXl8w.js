...
const hn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), ve = "copilot-", Xs = "24.7.5", lu = "attention-required", cu = "https://plugins.jetbrains.com/plugin/23758-vaadin", uu = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function du(e) {
...
function Jl() {
  Ee.push(import("./copilot-log-plugin-CroXZgT3.js")), Ee.push(import("./copilot-info-plugin-CYFSnVQ0.js")), Ee.push(import("./copilot-features-plugin-DRpe6fsL.js")), Ee.push(import("./copilot-feedback-plugin-BtL1-WBn.js")), Ee.push(import("./copilot-shortcuts-plugin-jjDBxF81.js"));
}
function Xl() {
  {
...
let ri = class extends Gl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-BhahPpqK.js"), await import("./copilot-init-step2-CqE-PfxQ.js"), il(), Jl(), this.tabIndex = 0, It.hostConnectedCallback(), window.addEventListener("keydown", Hn), this.addEventListener("keydown", ni), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
